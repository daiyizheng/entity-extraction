...
def get_argparse():
    ...
    parser.add_argument("--use_RoPE", default=True, type=bool,
                        help="Whether to use rotation position encoding")
    ...
    # global_pointer
    parser.add_argument("--global_pointer_learning_rate", default=5e-5, type=float,
                        help="The initial learning rate for GlobalPointer layer.")
