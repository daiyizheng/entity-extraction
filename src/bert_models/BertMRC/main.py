...
from src.bert_models.BertMRC.trainer import Trainer
from src.bert_models.BertMRC.data_loader import load_and_cache_examples
from src.bert_models.BertMRC.finetuning_argparse import get_argparse
from src.bert_models.BertMRC import MODEL_CLASSES
from src.bert_models.BertMRC.utils import override_defaults, seed_everything, get_labels
...
def main():
    ...
    labels_list = get_labels(args.labels)['labels']
    labels_list = labels_list + ["O"]
