...
def get_argparse():
    ...
    parser.add_argument("--config_yml_dir", default=None, type=str, required=True,
    ...
    parser.add_argument("--hidden_dropout_prob", default=0.5, type=float, help="")
    parser.add_argument("--sampling_ratio", default=1, type=float, help="")
    parser.add_argument("--do_hard_negative_sampling", default=False, type=bool, help="")
    parser.add_argument("--simplify_biaffine", default=True, type=bool, help="")
    parser.add_argument("--hns_multiplier", default=0.3, type=float, help="")
    ...
    # lstm
    parser.add_argument("--use_lstm", default=False, help="Whether to use lstm to extract the features")
    parser.add_argument("--lstm_learning_rate", default=5e-5, type=float, help="The initial learning rate for LSTM layer.")

    # ffn
    parser.add_argument("--use_ffn", default=False,  help="whether to use ffn before the biaffine layer")
    parser.add_argument("--ffn_learning_rate", default=5e-5, type=float, help="The initial learning rate for ffn.")

    # biaffine
    parser.add_argument("--biaffine_learning_rate", default=5e-5, type=float,  help="The initial learning rate for biaffine.")
    parser.add_argument("--use_focal", default=False, help="Whether to use focal loss")
